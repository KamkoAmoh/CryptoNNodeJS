...
export class DESCipher implements Cryptography {
    private algorithm: string = "des-ede-cbc";
    private password: string = "Lab42";
    private key: Buffer = crypto.scryptSync(this.password, 'salt', 16);
    private iv: Buffer = Buffer.alloc(8, 0);
